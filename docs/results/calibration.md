...
| Acquisition Proposal required to be publicly disclosed-Answer (Y/N) | 20 | 13 | 0.650 | [0.433, 0.819] | no |
...
best: Target's securities or credit rating: subject to "disproportionate impact" modifier 0.95
...
nothing about non-merger commercial contracts (CUAD's domain), a different model, a longer
