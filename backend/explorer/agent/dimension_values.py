...
Implementation in `semantic_explorer_base.agent.dimension_values`, including why *which* dimensions are closed
...
from semantic_explorer_base.agent.dimension_values import MAX_VOCABULARY
from semantic_explorer_base.agent.dimension_values import closed_dimensions as _closed
from semantic_explorer_base.agent.dimension_values import dimension_values as _values
