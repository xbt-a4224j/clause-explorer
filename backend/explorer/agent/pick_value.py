...
Implementation and the measurement in `quorum.agent.pick_value`: 14/16 on legal terms of art
...
from quorum.agent.pick_value import PICK_MODEL, SYSTEM_PROMPT
from quorum.agent.pick_value import pick_value as _pick_value
